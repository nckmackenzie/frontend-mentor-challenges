...
function Footer() {
  return (
    <footer className="bg-secondary-700 py-8">
      <div className="container flex flex-col items-center md:items-start md:flex-row gap-8 md:gap-16">
              ...
              <ul>
                {link?.children.map(child => (
                  <li key={child}>
                    <a
                      href=""
                      className="text-sm text-secondary-100 transition-all hover:text-primary"
                    >
                      {child}
                    </a>
                  </li>
        ...
        <div className="flex gap-4 items-center">
          <a
            ...
            target="_blank"
            className="text-white tranistion-all hover:text-primary"
          >
